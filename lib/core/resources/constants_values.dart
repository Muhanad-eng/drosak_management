...
class constList{
  static const List<OnBoardingModel> listImages=[
    OnBoardingModel(onBoardingImage:AssetsImagesManager.onBoardingImage1 ,onBoardingText:ConstantsValues.konBoardingText1 ),
     OnBoardingModel(onBoardingImage:AssetsImagesManager.onBoardingImage2 ,onBoardingText:ConstantsValues.konBoardingText2 ),
      OnBoardingModel(onBoardingImage:AssetsImagesManager.onBoardingImage3 ,onBoardingText:ConstantsValues.konBoardingText3 ),
       OnBoardingModel(onBoardingImage:AssetsImagesManager.onBoardingImage4 ,onBoardingText:ConstantsValues.konBoardingText4 ),
        OnBoardingModel(onBoardingImage:AssetsImagesManager.onBoardingImage5 ,onBoardingText:ConstantsValues.konBoardingText5 ),
  ];
}